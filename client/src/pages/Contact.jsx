...
function Contact() {
  ...
  const { full_name, email, subject, message } = emailFrom
  return (
    <section className='flex flex-col justify-center items-center gap-5 w-full md:h-[100vh] bg-transparent bg-blue-gray-900 mx-auto mt-4 sm:mt-8 md:mt-12 lg:mt-16'>
